...
namespace DiplRad
{
    static class JpegStandardTables
    {
        public static readonly int[,] LuminanceQuantizationTable = {
        ...
        public static readonly int[,] ChrominanceQuantizationTable = {
        ...
        public static readonly string[] LuminanceDCHuffmanTable = { "00", "010", "011", "100", "101", "110", "1110", "11110", "111110", "1111110", "11111110", "111111110" };
        public static readonly string[] ChrominanceDCHuffmanTable = { "00", "01", "10", "110", "1110", "11110", "111110", "1111110", "11111110", "111111110", "1111111110", "11111111110" };

        public static readonly string[,] LuminanceACHuffmanTable = {
        ...
        public static readonly string[,] ChrominanceACHuffmanTable = {
        ...
        private static Dictionary<string, int> _inverseLuminanceDCHuffmanTable = null;
        private static Dictionary<string, int> _inverseChrominanceDCHuffmanTable = null;
        private static Dictionary<string, Tuple<int, int>> _inverseLuminanceACHuffmanTable = null;
        private static Dictionary<string, Tuple<int, int>> _inverseChrominanceACHuffmanTable = null;

        public static Dictionary<string, int> InverseLuminanceDCHuffmanTable
        {
            get 
            {
                if (_inverseLuminanceDCHuffmanTable == null)
                {
                    _inverseLuminanceDCHuffmanTable = new Dictionary<string, int>();
                    for (int category = 0; category < LuminanceDCHuffmanTable.Length; category++)
                    {
                        _inverseLuminanceDCHuffmanTable.Add(LuminanceDCHuffmanTable[category], category);
                    }
                }

                return _inverseLuminanceDCHuffmanTable;
            }
        }

        public static Dictionary<string, int> InverseChrominanceDCHuffmanTable
        {
            get
            {
                if (_inverseChrominanceDCHuffmanTable == null)
                {
                    _inverseChrominanceDCHuffmanTable = new Dictionary<string, int>();
                    for (int category = 0; category < ChrominanceDCHuffmanTable.Length; category++)
                    {
                        _inverseChrominanceDCHuffmanTable.Add(ChrominanceDCHuffmanTable[category], category);
                    }
                }

                return _inverseChrominanceDCHuffmanTable;
            }
        }

        public static Dictionary<string, Tuple<int, int>> InverseLuminanceACHuffmanTable
        {
            get
            {
                if (_inverseLuminanceACHuffmanTable == null)
                {
                    _inverseLuminanceACHuffmanTable = new Dictionary<string, Tuple<int, int>>();
                    for (int category = 0; category < LuminanceACHuffmanTable.GetLength(1); category++)
                    {
                        for (int zeroesBefore = 0; zeroesBefore < LuminanceACHuffmanTable.GetLength(0); zeroesBefore++)
                        {
                            ...
                            {
                                _inverseLuminanceACHuffmanTable.Add(LuminanceACHuffmanTable[zeroesBefore, category], new Tuple<int, int>(category, zeroesBefore));
                            }
                        }
                    }
                }

                return _inverseLuminanceACHuffmanTable;
            }
        }

        public static Dictionary<string, Tuple<int, int>> InverseChrominanceACHuffmanTable
        {
            get
            {
                if (_inverseChrominanceACHuffmanTable == null)
                {
                    _inverseChrominanceACHuffmanTable = new Dictionary<string, Tuple<int, int>>();
                    for (int category = 0; category < ChrominanceACHuffmanTable.GetLength(1); category++)
                    {
                        for (int zeroesBefore = 0; zeroesBefore < ChrominanceACHuffmanTable.GetLength(0); zeroesBefore++)
                        {
                            ...
                            {
                                _inverseChrominanceACHuffmanTable.Add(ChrominanceACHuffmanTable[zeroesBefore, category], new Tuple<int, int>(category, zeroesBefore));
                            }
                        }
                    }
                }

                return _inverseChrominanceACHuffmanTable;
            }
        }
    }
}
